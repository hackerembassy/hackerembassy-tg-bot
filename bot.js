...
bot.onText(/^\/(start|help)(@.+?)?$/, (msg) => {
  bot.sendMessage(
    msg.chat.id,
    `🛠 Привет хакеровчанин. Я новый бот для менджмента всяких процессов в спейсе. 
...
bot.onText(/^\/(donate)(@.+?)?$/, (msg) => {
  ...
  bot.sendMessage(
    ...
    Мы будем радны любой поддержке. Задонатить нам можно с помощью банковской карты Visa/Mastercard Армении, крипты или налички при встрече.
